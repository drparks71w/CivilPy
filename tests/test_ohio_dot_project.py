...
class TestProject(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(self.tp.ctl_begin, 20.621)
        ...
        self.assertEqual(self.tp.structure_file_nbr, '5903394')
        self.assertEqual(self.tp.main_structure_type, '101N')
        self.assertEqual(self.tp.sufficiency_rating, '053.1')
        self.assertEqual(self.tp.ovrl_structure_length, 15)
        self.assertEqual(self.tp.deck_area, 465)
        self.assertEqual(self.tp.deck_width, 31)
        self.assertEqual(self.tp.feature_intersect, '                         ')
        self.assertEqual(self.tp.year_built, '1941')
        self.assertEqual(self.tp.longitude_begin_nbr, -82.663114)
        self.assertEqual(self.tp.latitude_begin_nbr, 40.631975)
